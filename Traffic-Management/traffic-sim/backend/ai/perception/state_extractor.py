...
from backend.ai.perception.detector import detect_vehicles_in_frame, reset_tracking_state, VEHICLE_CLASSES
from backend.ai.perception.video_pipeline import load_config
from backend.ai.perception.lane_processing import normalize_lane_regions
from backend.core.services.video_cache_service import get_video_hash, get_video_events, save_video_events
...
def extract_full_pipeline_data(video_path, config_path, progress_callback=None):
    ...
    save_video_events(video_hash, events, video_duration)
